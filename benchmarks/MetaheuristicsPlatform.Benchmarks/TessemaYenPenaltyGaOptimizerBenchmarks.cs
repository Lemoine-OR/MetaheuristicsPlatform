...
[MemoryDiagnoser] public class TessemaYenPenaltyGaOptimizerBenchmarks
{
 ...
 [Benchmark] public double Optimize()=>new TessemaYenPenaltyGaOptimizer().Optimize(_problem,new TessemaYenPenaltyGaParameters { MaximumGenerations = 2 },new OptimizationOptions{Seed=123456UL}).Best.Objective;
}
