...
[MemoryDiagnoser]
public class BiobjectiveMultimodalEaOptimizerBenchmarks
{
    ...
    {
        return new BiobjectiveMultimodalEaOptimizer()
            .Optimize(
                _problem,
                new BiobjectiveMultimodalEaParameters { MaximumGenerations = 2, PopulationSize = 24 },
