...
[MemoryDiagnoser]
public class BareBonesPsoScientificBenchmarks
{
    ...
    private readonly BareBonesPsoParameters _parameters = new BareBonesPsoParameters { SwarmSize = 20, MaximumIterations = 10 };
