...
[MemoryDiagnoser] public class InfeasibilityDrivenEaOptimizerBenchmarks
{
 ...
 [Benchmark] public double Optimize()=>new InfeasibilityDrivenEaOptimizer().Optimize(_problem,new InfeasibilityDrivenEaParameters { MaximumGenerations = 2, PopulationSize = 24 },new OptimizationOptions{Seed=123456UL}).Best.Objective;
}
