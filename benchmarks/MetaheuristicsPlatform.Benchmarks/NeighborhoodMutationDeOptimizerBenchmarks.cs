...
[MemoryDiagnoser]
public class NeighborhoodMutationDeOptimizerBenchmarks
{
    ...
    {
        return new NeighborhoodMutationDeOptimizer()
            .Optimize(
                _problem,
                new NeighborhoodMutationDeParameters { MaximumGenerations = 2, PopulationSize = 24, NeighborhoodSize = 6 },
