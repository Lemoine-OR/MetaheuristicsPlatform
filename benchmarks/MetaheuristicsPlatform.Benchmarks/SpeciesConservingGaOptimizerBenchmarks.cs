...
[MemoryDiagnoser]
public class SpeciesConservingGaOptimizerBenchmarks
{
    ...
    {
        return new SpeciesConservingGaOptimizer()
            .Optimize(
                _problem,
                new SpeciesConservingGaParameters { MaximumGenerations = 2, PopulationSize = 24 },
