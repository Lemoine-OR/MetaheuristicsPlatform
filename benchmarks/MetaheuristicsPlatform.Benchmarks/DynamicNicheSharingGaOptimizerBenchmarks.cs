...
[MemoryDiagnoser]
public class DynamicNicheSharingGaOptimizerBenchmarks
{
    ...
    {
        return new DynamicNicheSharingGaOptimizer()
            .Optimize(
                _problem,
                new DynamicNicheSharingGaParameters { MaximumGenerations = 2, PopulationSize = 24 },
