...
[MemoryDiagnoser]
public class AdaptiveNichingPsoOptimizerBenchmarks
{
    ...
    {
        return new AdaptiveNichingPsoOptimizer()
            .Optimize(
                _problem,
                new AdaptiveNichingPsoParameters { MaximumIterations = 2, SwarmSize = 24 },
