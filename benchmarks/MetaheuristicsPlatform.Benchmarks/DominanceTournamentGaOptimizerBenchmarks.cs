...
[MemoryDiagnoser] public class DominanceTournamentGaOptimizerBenchmarks
{
 ...
 [Benchmark] public double Optimize()=>new DominanceTournamentGaOptimizer().Optimize(_problem,new DominanceTournamentGaParameters { MaximumGenerations = 2 },new OptimizationOptions{Seed=123456UL}).Best.Objective;
}
