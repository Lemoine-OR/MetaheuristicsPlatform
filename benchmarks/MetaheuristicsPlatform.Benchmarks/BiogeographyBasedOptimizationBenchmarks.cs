...
[MemoryDiagnoser]
public class BBOScientificBenchmarks
{
    ...
    private readonly BiogeographyBasedOptimizationParameters _parameters =
        new() { PopulationSize = 20, MaximumIterations = 10, EliteCount = 2 };
