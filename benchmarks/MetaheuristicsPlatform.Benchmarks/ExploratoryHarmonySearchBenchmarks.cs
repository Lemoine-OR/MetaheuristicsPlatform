...
[MemoryDiagnoser]
public class ExploratoryHarmonySearchBenchmarks
{
    ...
    private readonly ExploratoryHarmonySearchParameters _parameters = new ExploratoryHarmonySearchParameters { HarmonyMemorySize = 10, MaximumImprovisations = 25 };

    [Benchmark]
    public double ExploratoryHarmonySearch() =>
        new ExploratoryHarmonySearchOptimizer()
            .Optimize(
                _problem,
                _parameters,
                _cloner,
