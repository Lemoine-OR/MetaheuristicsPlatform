...
[MemoryDiagnoser]
public class TLBOScientificBenchmarks
{
    ...
    private readonly TeachingLearningBasedOptimizationParameters _parameters = new() { PopulationSize = 20, MaximumIterations = 10 };
