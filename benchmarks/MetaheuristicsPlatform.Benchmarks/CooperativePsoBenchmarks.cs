...
[MemoryDiagnoser]
public class CooperativePsoScientificBenchmarks
{
    ...
    private readonly CooperativePsoParameters _parameters = new CooperativePsoParameters { SubswarmCount = 6, SubswarmSize = 10, MaximumIterations = 10 };
