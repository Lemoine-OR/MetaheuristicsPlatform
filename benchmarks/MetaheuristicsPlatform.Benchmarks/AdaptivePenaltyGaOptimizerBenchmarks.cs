...
[MemoryDiagnoser] public class AdaptivePenaltyGaOptimizerBenchmarks
{
 ...
 [Benchmark] public double Optimize()=>new AdaptivePenaltyGaOptimizer().Optimize(_problem,new AdaptivePenaltyGaParameters { MaximumGenerations = 2 },new OptimizationOptions{Seed=123456UL}).Best.Objective;
}
