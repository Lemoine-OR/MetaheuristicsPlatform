...
[MemoryDiagnoser] public class HomomorphousMappingEaOptimizerBenchmarks
{
 ...
 [Benchmark] public double Optimize()=>new HomomorphousMappingEaOptimizer().Optimize(_problem,new HomomorphousMappingEaParameters { MaximumGenerations = 2 },new OptimizationOptions{Seed=123456UL}).Best.Objective;
}
