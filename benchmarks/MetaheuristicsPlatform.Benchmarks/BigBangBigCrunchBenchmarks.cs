...
[MemoryDiagnoser]
public class BBBCScientificBenchmarks
{
    private readonly ContinuousOptimizationProblem _problem =
        new(BoundedContinuousSearchSpace.Uniform(30, -5.0, 5.0), OptimizationSense.Minimize, Sphere);
    private readonly ArraySolutionCloner<double> _cloner = new();
    private readonly BigBangBigCrunchParameters _parameters = new() { PopulationSize = 20, MaximumIterations = 10 };
