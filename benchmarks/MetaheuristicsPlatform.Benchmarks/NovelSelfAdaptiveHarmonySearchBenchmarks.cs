...
[MemoryDiagnoser]
public class NovelSelfAdaptiveHarmonySearchBenchmarks
{
    ...
    private readonly NovelSelfAdaptiveHarmonySearchParameters _parameters = new NovelSelfAdaptiveHarmonySearchParameters { HarmonyMemorySize = 10, MaximumImprovisations = 25 };

    [Benchmark]
    public double NovelSelfAdaptiveHarmonySearch() =>
        new NovelSelfAdaptiveHarmonySearchOptimizer()
            .Optimize(
                _problem,
                _parameters,
                _cloner,
