...
[MemoryDiagnoser]
public class ParameterSettingFreeHarmonySearchBenchmarks
{
    ...
    private readonly ParameterSettingFreeHarmonySearchParameters _parameters =
        new()
        {
            HarmonyMemorySize = 30,
            MaximumImprovisations = 300,
            RehearsalMemoryCycles = 3,
            PitchAdjustmentBandwidthFractionOfRange = 0.001
        };

    [Benchmark]
    public double ParameterSettingFreeHarmonySearch() =>
