...
public sealed class CaseBasedHyperHeuristicParameters : IMetaheuristicParameters
{
    ...
    public void Validate()
    {
        ...
        if (MaximumCases <= 0) throw new ArgumentOutOfRangeException(nameof(MaximumCases));
    }
}
