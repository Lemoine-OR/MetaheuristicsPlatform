...
public sealed class FrrmabHyperHeuristicOptimizer :
    IHyperHeuristicOptimizer<FrrmabHyperHeuristicParameters>
{
    public MetaheuristicDescriptor Descriptor { get; } =
        new()
        {
            Id = MetaheuristicAlgorithmIds.FrrmabHyperHeuristic,
            Name = "Fitness-Rate-Rank Multi-Armed Bandit",
            Acronym = "FRRMAB",
            ...
            References =
                new[]
                {
                    FrrmabHyperHeuristicOptimizerReferences.Primary
                }
        };

public HyperHeuristicOptimizationResult Optimize(
        IHyperHeuristicDomain domain,
        FrrmabHyperHeuristicParameters parameters,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        for (int iteration = 0; iteration < parameters.MaximumIterations; iteration++)
        {
            ...
            int selected = FitnessRateRank(pulls, rewards, iteration, parameters.Exploration, random);
            ...
            rewards[selected] *= parameters.Decay;
    ...
    private static int FitnessRateRank(IReadOnlyList<int> pulls, IReadOnlyList<double> rewards, int iteration, double exploration, IRandomSource random)
    {
