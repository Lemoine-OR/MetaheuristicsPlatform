...
public sealed class ExtremeValueMabHyperHeuristicParameters : IMetaheuristicParameters
{
    public int MaximumIterations { get; init; } = 400;
    public double LearningRate { get; init; } = 0.2;
    public double Exploration { get; init; } = 1.0;
    public int RewardWindow { get; init; } = 20;
    ...
    public void Validate()
    {
        ...
        if (RewardWindow <= 0) throw new ArgumentOutOfRangeException(nameof(RewardWindow));
    }
}
