...
public sealed class HypeParameters : IMetaheuristicParameters
{
    public int PopulationSize { get; init; } = 80;
    public int MaximumGenerations { get; init; } = 200;
    public int HypervolumeSamples { get; init; } = 10000;
    ...
    public void Validate()
    {
        ...
        if (HypervolumeSamples < 100) throw new ArgumentOutOfRangeException(nameof(HypervolumeSamples));
