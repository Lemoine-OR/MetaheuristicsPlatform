...
public sealed class ThetaDeaParameters : IMetaheuristicParameters
{
    ...
    public double Theta { get; init; } = 5.0;
    ...
    public void Validate()
    {
        ...
        if (!double.IsFinite(Theta) || Theta <= 0) throw new ArgumentOutOfRangeException(nameof(Theta));
