...
/// </summary>
/// <remarks>
/// Implements Tanabe and Fukunaga (2013):
/// DE/current-to-pbest/1/bin, external archive, and circular historical memories
/// of successful F and CR settings.
///
/// DOI: 10.1109/CEC.2013.6557555.
/// </remarks>
public sealed class ShadeOptimizer :
    IMetaheuristic<double[], ShadeParameters>
{
    public MetaheuristicDescriptor Descriptor { get; } =
        new()
        {
            ...
            References =
                new[]
                {
                    DeAdaptiveReferences.TanabeFukunaga2013
                }
        };

    public ShadeParameters CreateDefaultParameters() =>
        new();

    public OptimizationResult<double[]> Optimize(
        IOptimizationProblem<double[]> problem,
        ShadeParameters parameters,
        ...
        CancellationToken cancellationToken = default)
    {
            ...
            ISpanContinuousOptimizationProblem continuousProblem)
        {
            throw new NotSupportedException(
                "The high-performance continuous SHADE implementation requires " +
        ...
        ShadeParameterAdaptationPolicy adaptation =
    ...
    private static ShadeIterationState CreateState(
        int populationSize,
        int dimension,
        ...
        ShadeParameterAdaptationPolicy adaptation)
    {
        ReadOnlySpan<double> memoryF =
            adaptation.Memory.DifferentialWeights;

        ReadOnlySpan<double> memoryCr =
            adaptation.Memory.CrossoverProbabilities;
        ...
        return new ShadeIterationState(
            populationSize,
            dimension,
            successfulTrials,
            archiveCount,
