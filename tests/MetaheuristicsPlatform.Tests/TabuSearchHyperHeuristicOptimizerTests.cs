using MetaheuristicsPlatform.Algorithms.HyperHeuristics.TabuSearchHyperHeuristic;
...
public sealed class TabuSearchHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<TabuSearchHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<TabuSearchHyperHeuristicOptimizer>(
