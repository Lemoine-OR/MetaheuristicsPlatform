...
public sealed class AdaptiveRestrictedTournamentGaOptimizerTests
{
    [Fact]
    public void Optimize_ReturnsDistinctOptima_AndFactoryCreatesCanonicalType()
    {
        ...
        MultimodalOptimizationResult result =
            new AdaptiveRestrictedTournamentGaOptimizer().Optimize(
                problem,
                new AdaptiveRestrictedTournamentGaParameters { MaximumGenerations = 4, PopulationSize = 24 },
        ...
        Assert.IsType<AdaptiveRestrictedTournamentGaOptimizer>(
            MetaheuristicFactory.Create<AdaptiveRestrictedTournamentGaOptimizer>(
