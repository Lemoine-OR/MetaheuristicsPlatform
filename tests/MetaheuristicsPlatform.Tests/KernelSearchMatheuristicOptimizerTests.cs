using MetaheuristicsPlatform.Algorithms.Matheuristics.KernelSearch;
...
public sealed class KernelSearchMatheuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<KernelSearchMatheuristicOptimizer>(
            MetaheuristicFactory.Create<KernelSearchMatheuristicOptimizer>(
