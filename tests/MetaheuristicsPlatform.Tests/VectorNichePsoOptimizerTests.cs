...
public sealed class VectorNichePsoOptimizerTests
{
    [Fact]
    public void Optimize_ReturnsDistinctOptima_AndFactoryCreatesCanonicalType()
    {
        ...
        MultimodalOptimizationResult result =
            new VectorNichePsoOptimizer().Optimize(
                problem,
                new VectorNichePsoParameters { MaximumIterations = 4, SwarmSize = 24 },
        ...
        Assert.IsType<VectorNichePsoOptimizer>(
            MetaheuristicFactory.Create<VectorNichePsoOptimizer>(
