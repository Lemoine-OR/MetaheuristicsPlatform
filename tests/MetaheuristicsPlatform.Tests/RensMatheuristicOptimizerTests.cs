using MetaheuristicsPlatform.Algorithms.Matheuristics.RENS;
...
public sealed class RensMatheuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<RensMatheuristicOptimizer>(
            MetaheuristicFactory.Create<RensMatheuristicOptimizer>(
