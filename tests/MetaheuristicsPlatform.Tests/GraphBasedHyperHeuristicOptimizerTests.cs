using MetaheuristicsPlatform.Algorithms.HyperHeuristics.GraphBasedHyperHeuristic;
...
public sealed class GraphBasedHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<GraphBasedHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<GraphBasedHyperHeuristicOptimizer>(
