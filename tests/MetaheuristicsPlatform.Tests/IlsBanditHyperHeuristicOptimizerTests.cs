using MetaheuristicsPlatform.Algorithms.HyperHeuristics.IlsBanditHyperHeuristic;
...
public sealed class IlsBanditHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<IlsBanditHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<IlsBanditHyperHeuristicOptimizer>(
