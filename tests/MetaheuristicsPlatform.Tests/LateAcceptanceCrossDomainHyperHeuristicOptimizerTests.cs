using MetaheuristicsPlatform.Algorithms.HyperHeuristics.LateAcceptanceCrossDomainHyperHeuristic;
...
public sealed class LateAcceptanceCrossDomainHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<LateAcceptanceCrossDomainHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<LateAcceptanceCrossDomainHyperHeuristicOptimizer>(
