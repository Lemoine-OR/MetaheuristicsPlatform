using MetaheuristicsPlatform.Algorithms.HyperHeuristics.ReinforcementLearningGreatDelugeHyperHeuristic;
...
public sealed class ReinforcementLearningGreatDelugeHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<ReinforcementLearningGreatDelugeHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<ReinforcementLearningGreatDelugeHyperHeuristicOptimizer>(
