using MetaheuristicsPlatform.Algorithms.HyperHeuristics.FrrmabHyperHeuristic;
...
public sealed class FrrmabHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<FrrmabHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<FrrmabHyperHeuristicOptimizer>(
