...
public sealed class BiobjectiveMultimodalEaOptimizerTests
{
    [Fact]
    public void Optimize_ReturnsDistinctOptima_AndFactoryCreatesCanonicalType()
    {
        ...
        MultimodalOptimizationResult result =
            new BiobjectiveMultimodalEaOptimizer().Optimize(
                problem,
                new BiobjectiveMultimodalEaParameters { MaximumGenerations = 4, PopulationSize = 24 },
        ...
        Assert.IsType<BiobjectiveMultimodalEaOptimizer>(
            MetaheuristicFactory.Create<BiobjectiveMultimodalEaOptimizer>(
