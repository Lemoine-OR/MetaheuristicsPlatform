using MetaheuristicsPlatform.Algorithms.HyperHeuristics.CaseBasedHyperHeuristic;
...
public sealed class CaseBasedHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<CaseBasedHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<CaseBasedHyperHeuristicOptimizer>(
