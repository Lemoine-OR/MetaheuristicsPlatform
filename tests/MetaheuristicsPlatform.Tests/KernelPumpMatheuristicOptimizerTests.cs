using MetaheuristicsPlatform.Algorithms.Matheuristics.KernelPump;
...
public sealed class KernelPumpMatheuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<KernelPumpMatheuristicOptimizer>(
            MetaheuristicFactory.Create<KernelPumpMatheuristicOptimizer>(
