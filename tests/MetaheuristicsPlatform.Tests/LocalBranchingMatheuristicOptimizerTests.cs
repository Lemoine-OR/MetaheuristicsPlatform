...
public sealed class LocalBranchingMatheuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<LocalBranchingMatheuristicOptimizer>(
            MetaheuristicFactory.Create<LocalBranchingMatheuristicOptimizer>(
