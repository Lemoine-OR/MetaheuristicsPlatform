...
public sealed class CrowdingDeOptimizerTests
{
    [Fact]
    public void Optimize_ReturnsDistinctOptima_AndFactoryCreatesCanonicalType()
    {
        ...
        MultimodalOptimizationResult result =
            new CrowdingDeOptimizer().Optimize(
                problem,
                new CrowdingDeParameters { MaximumGenerations = 4, PopulationSize = 24 },
        ...
        Assert.IsType<CrowdingDeOptimizer>(
            MetaheuristicFactory.Create<CrowdingDeOptimizer>(
