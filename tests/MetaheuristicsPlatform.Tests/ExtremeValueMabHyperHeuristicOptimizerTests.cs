using MetaheuristicsPlatform.Algorithms.HyperHeuristics.ExtremeValueMabHyperHeuristic;
...
public sealed class ExtremeValueMabHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<ExtremeValueMabHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<ExtremeValueMabHyperHeuristicOptimizer>(
