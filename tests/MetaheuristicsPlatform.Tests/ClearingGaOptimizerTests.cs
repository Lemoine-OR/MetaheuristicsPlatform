...
public sealed class ClearingGaOptimizerTests
{
    [Fact]
    public void Optimize_ReturnsDistinctOptima_AndFactoryCreatesCanonicalType()
    {
        ...
        MultimodalOptimizationResult result =
            new ClearingGaOptimizer().Optimize(
                problem,
                new ClearingGaParameters { MaximumGenerations = 4, PopulationSize = 24 },
        ...
        Assert.IsType<ClearingGaOptimizer>(
            MetaheuristicFactory.Create<ClearingGaOptimizer>(
