...
public sealed class SpeciesBasedPsoOptimizerTests
{
    [Fact]
    public void Optimize_ReturnsDistinctOptima_AndFactoryCreatesCanonicalType()
    {
        ...
        MultimodalOptimizationResult result =
            new SpeciesBasedPsoOptimizer().Optimize(
                problem,
                new SpeciesBasedPsoParameters { MaximumIterations = 4, SwarmSize = 24 },
        ...
        Assert.IsType<SpeciesBasedPsoOptimizer>(
            MetaheuristicFactory.Create<SpeciesBasedPsoOptimizer>(
