...
public sealed class LocallyInformedPsoOptimizerTests
{
    [Fact]
    public void Optimize_ReturnsDistinctOptima_AndFactoryCreatesCanonicalType()
    {
        ...
        MultimodalOptimizationResult result =
            new LocallyInformedPsoOptimizer().Optimize(
                problem,
                new LocallyInformedPsoParameters { MaximumIterations = 4, SwarmSize = 24, NeighborhoodSize = 4 },
        ...
        Assert.IsType<LocallyInformedPsoOptimizer>(
            MetaheuristicFactory.Create<LocallyInformedPsoOptimizer>(
