using MetaheuristicsPlatform.Algorithms.Matheuristics.GeneralFeasibilityPump;
...
public sealed class GeneralMipFeasibilityPumpOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<GeneralMipFeasibilityPumpOptimizer>(
            MetaheuristicFactory.Create<GeneralMipFeasibilityPumpOptimizer>(
