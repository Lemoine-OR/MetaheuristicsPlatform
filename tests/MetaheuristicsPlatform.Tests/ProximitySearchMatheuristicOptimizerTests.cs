using MetaheuristicsPlatform.Algorithms.Matheuristics.ProximitySearch;
...
public sealed class ProximitySearchMatheuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<ProximitySearchMatheuristicOptimizer>(
            MetaheuristicFactory.Create<ProximitySearchMatheuristicOptimizer>(
