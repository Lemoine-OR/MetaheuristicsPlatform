using MetaheuristicsPlatform.Algorithms.Matheuristics.RINS;
...
public sealed class RinsMatheuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<RinsMatheuristicOptimizer>(
            MetaheuristicFactory.Create<RinsMatheuristicOptimizer>(
