using MetaheuristicsPlatform.Algorithms.GreyWolf;
...
public sealed class GWOScientificTests
{
    [Fact]
    ...
    public void OneCompleteIterationHasExactEvaluationAccounting()
    {
        OptimizationResult<double[]> result =
            new GreyWolfOptimizer().Optimize(
                CreateSphere(4),
    ...
    public void InvalidScientificControlsAreRejected()
    {
        Assert.Throws<ArgumentOutOfRangeException>(
            () =>
                new GreyWolfOptimizerParameters { PopulationSize = 2 }.Validate());
    }
