using MetaheuristicsPlatform.Algorithms.HyperHeuristics.DynamicMabHyperHeuristic;
...
public sealed class DynamicMabHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<DynamicMabHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<DynamicMabHyperHeuristicOptimizer>(
