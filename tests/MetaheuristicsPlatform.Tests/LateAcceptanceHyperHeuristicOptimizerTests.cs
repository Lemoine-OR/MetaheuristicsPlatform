...
public sealed class LateAcceptanceHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<LateAcceptanceHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<LateAcceptanceHyperHeuristicOptimizer>(
