using MetaheuristicsPlatform.Algorithms.HyperHeuristics.BanditAosHyperHeuristic;
...
public sealed class BanditAosHyperHeuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesDomainHeuristicPool_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<BanditAosHyperHeuristicOptimizer>(
            MetaheuristicFactory.Create<BanditAosHyperHeuristicOptimizer>(
