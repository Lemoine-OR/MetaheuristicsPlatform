...
public sealed class NsgaIIIOptimizerTests
{
    ...
    public void Optimize_ReturnsNondominatedFront_AndFactoryCreatesCanonicalType()
    {
        ...
        NsgaIIIParameters parameters = new() { MaximumGenerations = 5 };

        MultiobjectiveOptimizationResult result =
            new NsgaIIIOptimizer().Optimize(
                problem,
                parameters,
        ...
        Assert.IsType<NsgaIIIOptimizer>(
