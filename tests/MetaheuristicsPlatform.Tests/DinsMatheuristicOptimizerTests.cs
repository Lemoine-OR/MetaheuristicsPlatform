using MetaheuristicsPlatform.Algorithms.Matheuristics.DINS;
...
public sealed class DinsMatheuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<DinsMatheuristicOptimizer>(
            MetaheuristicFactory.Create<DinsMatheuristicOptimizer>(
