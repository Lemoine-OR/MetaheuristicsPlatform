using MetaheuristicsPlatform.Algorithms.Matheuristics.FeasibilityPump;
...
public sealed class FeasibilityPumpMatheuristicOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<FeasibilityPumpMatheuristicOptimizer>(
            MetaheuristicFactory.Create<FeasibilityPumpMatheuristicOptimizer>(
