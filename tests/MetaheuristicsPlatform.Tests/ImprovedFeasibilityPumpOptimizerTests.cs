using MetaheuristicsPlatform.Algorithms.Matheuristics.ImprovedFeasibilityPump;
...
public sealed class ImprovedFeasibilityPumpOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<ImprovedFeasibilityPumpOptimizer>(
            MetaheuristicFactory.Create<ImprovedFeasibilityPumpOptimizer>(
