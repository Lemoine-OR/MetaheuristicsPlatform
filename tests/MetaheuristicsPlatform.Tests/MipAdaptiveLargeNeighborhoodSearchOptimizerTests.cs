using MetaheuristicsPlatform.Algorithms.Matheuristics.MipAdaptiveLns;
...
public sealed class MipAdaptiveLargeNeighborhoodSearchOptimizerTests
{
    [Fact]
    public void Optimize_UsesExactRepairDomain_AndFactoryCreatesCanonicalType()
    {
        ...
        Assert.IsType<MipAdaptiveLargeNeighborhoodSearchOptimizer>(
            MetaheuristicFactory.Create<MipAdaptiveLargeNeighborhoodSearchOptimizer>(
