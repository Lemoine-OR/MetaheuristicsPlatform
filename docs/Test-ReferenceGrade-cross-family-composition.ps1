...
$pagePath = Join-Path $Root "docs\pages\reference-grade\cross-family-composition.md"
$sourcePath = Join-Path $Root "src\MetaheuristicsPlatform\ReferenceGrade\CrossFamilyCompositionContract.cs"
...
foreach ($marker in @(
        ...
        "## Stability guarantee",
        "## Versioning rule",
        "## Validation",        "reference-grade-cross-family-composition",
        "v0.170.0"
)) {
...
Write-Host "Reference-grade contract GREEN: reference-grade-cross-family-composition" -ForegroundColor Green
