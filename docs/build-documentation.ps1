...
& (Join-Path $Root "docs\Build-AcceptanceBasedTrajectoryDocumentation.ps1") -Root $Root -Site $site
...
& (Join-Path $Root "docs\Build-CmaEsDocumentation.ps1") -Root $Root -Site $site
