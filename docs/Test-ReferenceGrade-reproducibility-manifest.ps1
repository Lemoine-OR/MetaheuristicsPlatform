...
$pagePath = Join-Path $Root "docs\pages\reference-grade\reproducibility-manifest.md"
$sourcePath = Join-Path $Root "src\MetaheuristicsPlatform\ReferenceGrade\ReproducibilityManifest.cs"
...
foreach ($marker in @(
        ...
        "## Stability guarantee",
        "## Versioning rule",
        "## Validation",        "reference-grade-reproducibility-manifest",
        "v0.167.0"
)) {
...
Write-Host "Reference-grade contract GREEN: reference-grade-reproducibility-manifest" -ForegroundColor Green
