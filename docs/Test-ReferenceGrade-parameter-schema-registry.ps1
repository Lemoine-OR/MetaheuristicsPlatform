...
$pagePath = Join-Path $Root "docs\pages\reference-grade\parameter-schema-registry.md"
$sourcePath = Join-Path $Root "src\MetaheuristicsPlatform\ReferenceGrade\ParameterSchemaRegistry.cs"
...
foreach ($marker in @(
        ...
        "## Stability guarantee",
        "## Versioning rule",
        "## Validation",        "reference-grade-parameter-schema-registry",
        "v0.168.0"
)) {
...
Write-Host "Reference-grade contract GREEN: reference-grade-parameter-schema-registry" -ForegroundColor Green
