...
& (Join-Path $Root "docs\Test-KernelPumpMatheuristic.ps1") -Root $Root

& (Join-Path $Root "docs\Test-CmsaMatheuristic.ps1") -Root $Root

& (Join-Path $Root "docs\Test-ProximitySearchMatheuristic.ps1") -Root $Root

& (Join-Path $Root "docs\Test-RensMatheuristic.ps1") -Root $Root

& (Join-Path $Root "docs\Test-MipAdaptiveLargeNeighborhoodSearch.ps1") -Root $Root

& (Join-Path $Root "docs\Test-KernelSearchMatheuristic.ps1") -Root $Root

& (Join-Path $Root "docs\Test-DinsMatheuristic.ps1") -Root $Root

& (Join-Path $Root "docs\Test-ImprovedFeasibilityPump.ps1") -Root $Root

& (Join-Path $Root "docs\Test-GeneralMipFeasibilityPump.ps1") -Root $Root

& (Join-Path $Root "docs\Test-FeasibilityPumpMatheuristic.ps1") -Root $Root

& (Join-Path $Root "docs\Test-RinsMatheuristic.ps1") -Root $Root
...
& (Join-Path $Root "docs\Test-BanditAosHyperHeuristic.ps1") -Root $Root

& (Join-Path $Root "docs\Test-ExtremeValueMabHyperHeuristic.ps1") -Root $Root

& (Join-Path $Root "docs\Test-DynamicMabHyperHeuristic.ps1") -Root $Root

& (Join-Path $Root "docs\Test-LateAcceptanceHyperHeuristic.ps1") -Root $Root
...
& (Join-Path $Root "docs\Test-AdaptiveRestrictedTournamentGa.ps1") -Root $Root
...
& (Join-Path $Root "docs\Test-LocallyInformedPso.ps1") -Root $Root

& (Join-Path $Root "docs\Test-NeighborhoodMutationDe.ps1") -Root $Root

& (Join-Path $Root "docs\Test-AdaptiveNichingPso.ps1") -Root $Root

& (Join-Path $Root "docs\Test-VectorNichePso.ps1") -Root $Root

& (Join-Path $Root "docs\Test-SpeciesBasedPso.ps1") -Root $Root

& (Join-Path $Root "docs\Test-CrowdingDe.ps1") -Root $Root

& (Join-Path $Root "docs\Test-SpeciesConservingGa.ps1") -Root $Root

& (Join-Path $Root "docs\Test-ClearingGa.ps1") -Root $Root

& (Join-Path $Root "docs\Test-InfeasibilityDrivenEa.ps1") -Root $Root

& (Join-Path $Root "docs\Test-EnsembleConstraintHandling.ps1") -Root $Root
...
$requiredRepoFiles = @(
    ...
    "docs\Test-EnsembleConstraintHandling.ps1",
    "docs\pages\algorithms\ensemble-constraint-handling-mallipeddi-suganthan-2010.md",
    "docs\Test-InfeasibilityDrivenEa.ps1",
    "docs\pages\algorithms\infeasibility-driven-ea-ray-singh-isaacs-smith-2009.md",
    "docs\Test-ClearingGa.ps1",
    "docs\pages\algorithms\clearing-ga-petrowski-1996.md",
    "docs\Test-SpeciesConservingGa.ps1",
    "docs\pages\algorithms\species-conserving-ga-li-balazs-parks-clarkson-2002.md",
    "docs\Test-CrowdingDe.ps1",
    "docs\pages\algorithms\crowding-de-thomsen-2004.md",
    "docs\Test-SpeciesBasedPso.ps1",
    "docs\pages\algorithms\species-based-pso-li-2004.md",
    "docs\Test-VectorNichePso.ps1",
    "docs\pages\algorithms\vector-niche-pso-schoeman-engelbrecht-2004.md",
    "docs\Test-AdaptiveNichingPso.ps1",
    "docs\pages\algorithms\adaptive-niching-pso-bird-li-2006.md",
    "docs\Test-NeighborhoodMutationDe.ps1",
    "docs\pages\algorithms\neighborhood-mutation-de-qu-suganthan-liang-2012.md",
    "docs\Test-LocallyInformedPso.ps1",
    "docs\pages\algorithms\distance-based-lips-qu-suganthan-das-2013.md",
    "docs\Test-BiobjectiveMultimodalEa.ps1",
    ...
    "docs\Test-AdaptiveRestrictedTournamentGa.ps1",
    "docs\pages\algorithms\adaptive-rts-ga-roy-parmee-2006.md",
    "docs\Test-TabuSearchHyperHeuristic.ps1",
    ...
    "docs\Test-LateAcceptanceCrossDomainHyperHeuristic.ps1",
...
if ([string]$version.version -ne "0.172.0") {
    throw "Documentation parity: version.json must be 0.172.0 for this release."
}
