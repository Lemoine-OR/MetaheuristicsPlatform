...
$pagePath = Join-Path $Root "docs\pages\reference-grade\scientific-provenance.md"
$sourcePath = Join-Path $Root "src\MetaheuristicsPlatform\ReferenceGrade\ScientificProvenanceRecord.cs"
...
foreach ($marker in @(
        ...
        "## Stability guarantee",
        "## Versioning rule",
        "## Validation",        "reference-grade-scientific-provenance",
        "v0.166.0"
)) {
...
Write-Host "Reference-grade contract GREEN: reference-grade-scientific-provenance" -ForegroundColor Green
