...
- Added `CrossFamilyCompositionContract` reference-grade contract; existing algorithm IDs and optimizer signatures are unchanged.
...
- Added stable direct-factory algorithm ID `feasibility-pump-fischetti-glover-lodi-2005` (`FeasibilityPumpMatheuristicOptimizer`). Existing public IDs and signatures are unchanged.
...
- Added stable direct-factory algorithm ID `case-based-heuristic-selection-burke-petrovic-qu-2006` (`CaseBasedHyperHeuristicOptimizer`). Existing public IDs and signatures are unchanged.
...
- Added stable direct-factory algorithm ID `fuzzy-clustering-niching-ga-imrani-bouroumi-zine-limouri-2000` (`FuzzyClusteringNichingGaOptimizer`). Existing public IDs and signatures are unchanged.
...
- Added stable direct-factory algorithm ID `distance-based-lips-qu-suganthan-das-2013` (`LocallyInformedPsoOptimizer`). Existing public IDs and signatures are unchanged.
...
- Added stable direct-factory algorithm ID `rvea-cheng-jin-olhofer-sendhoff-2016` (`RveaOptimizer`). Existing public IDs and signatures are unchanged.
...
- Added stable direct-factory algorithm ID `species-based-particle-swarm-parrott-li-2006` (`SpeciesBasedParticleSwarmOptimizer`). Existing public IDs and signatures are unchanged.
...
- Added stable direct-factory algorithm ID `crow-search-algorithm-askarzadeh-2016` (`CrowSearchOptimizer`). Existing public IDs and signatures are unchanged.

## v0.80.0

- Added stable direct-factory algorithm ID `teaching-learning-based-optimization-rao-savsani-vakharia-2011` (`TeachingLearningBasedOptimizationOptimizer`). Existing public IDs and signatures are unchanged.
